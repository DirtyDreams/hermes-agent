...
export default function DiscoveryFeed() {
  ...
  if (!profiles || profiles.length <= currentIndex || !currentProfile)
    return (
      ...
      <AnimatePresence mode="wait">
        ...
        >
          <div style={{ position: 'relative', aspectRatio: '3/4' }}>
            <img
              src={
                currentProfile.photos?.[0]?.cdnUrl ||
                'https://images.unsplash.com/photo-1534528741775-53994a69daeb?q=80&w=450&h=600&auto=format&fit=crop'
              }
            ...
            >
              <Link to={`/profile/${currentProfile.id}`} className="hover:underline flex items-baseline gap-2">
